...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"943c8851-3a90-4519-a8c2-cfabcf2de34b\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [31 x i8] c"com.companyname.location_app_2\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555261, ; android_runtime_jnienv_class_token
	i32 100672134, ; jnienv_initialize_method_token
	i32 100672133, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.59 = internal constant [29 x i8] c"libaot-Location_app_2.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 107
	%struct.DSOCacheEntry {
		i64 4574162012759527366, ; hash 0x3f7ab01d9b9e0fc6, from name: Location_app_2
		i8 0, ; ignore
	...
	; 158
	%struct.DSOCacheEntry {
		i64 7388983701481658342, ; hash 0x668af18729f717e6, from name: libaot-Location_app_2.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.59, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 189
	%struct.DSOCacheEntry {
		i64 8428390408463963320, ; hash 0x74f7a86bc4cdd4b8, from name: aot-Location_app_2.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.59, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 207
	%struct.DSOCacheEntry {
		i64 8782124132759869945, ; hash 0x79e05f5e7a8999f9, from name: libaot-Location_app_2
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.59, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 356
	%struct.DSOCacheEntry {
		i64 14278949682095001174, ; hash 0xc62905152ef30e56, from name: aot-Location_app_2
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.59, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 423
	%struct.DSOCacheEntry {
		i64 17046207775808988556, ; hash 0xec904ba84c98a58c, from name: Location_app_2.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.59, i32 0, i32 0), ; name
		i8* null; handle
	}, 
